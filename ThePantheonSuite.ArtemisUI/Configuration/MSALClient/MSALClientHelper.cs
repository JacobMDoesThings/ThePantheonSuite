...
/// <summary>
    ...
    public class MSALClientHelper
    {
        ...
        public static readonly string KeyChainServiceName = "Pantheon.Artemis";

        public static readonly string KeyChainAccountName = "MSALCache";

        public static readonly KeyValuePair<string, string> LinuxKeyRingAttr2 = new KeyValuePair<string, string>("ProductGroup", "Pantheon");
