...
namespace ThePantheonSuite.ArtemisUI.Configuration.MSALClient;
...
public class PublicClientSingleton
{
    ...
    private PublicClientSingleton()
    {
        ...
        using var stream = assembly.GetManifestResourceStream("ThePantheonSuite.ArtemisUI.appsettings.json");
